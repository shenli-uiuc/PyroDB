...
public final class HBaseProtos {
  ...
  public interface RegionInfoOrBuilder
    ...
    // repeated bytes split_key = 7;
    /**
     * <code>repeated bytes split_key = 7;</code>
     *
     * <pre>
     * Shen Li
     * </pre>
     */
    java.util.List<com.google.protobuf.ByteString> getSplitKeyList();
    /**
     * <code>repeated bytes split_key = 7;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    com.google.protobuf.ByteString getSplitKey(int index);

    // repeated int32 rg_id = 8 [packed = true];
    /**
     * <code>repeated int32 rg_id = 8 [packed = true];</code>
     */
    java.util.List<java.lang.Integer> getRgIdList();
    /**
     * <code>repeated int32 rg_id = 8 [packed = true];</code>
     */
    int getRgIdCount();
  ...
  public static final class RegionInfo extends
    ...
    private RegionInfo(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 58: {
              if (!((mutable_bitField0_ & 0x00000040) == 0x00000040)) {
                splitKey_ = new java.util.ArrayList<com.google.protobuf.ByteString>();
                mutable_bitField0_ |= 0x00000040;
              }
              splitKey_.add(input.readBytes());
              break;
            }
            case 64: {
              if (!((mutable_bitField0_ & 0x00000080) == 0x00000080)) {
                rgId_ = new java.util.ArrayList<java.lang.Integer>();
                mutable_bitField0_ |= 0x00000080;
              }
              rgId_.add(input.readInt32());
              break;
            }
            case 66: {
        ...
        if (((mutable_bitField0_ & 0x00000040) == 0x00000040)) {
          splitKey_ = java.util.Collections.unmodifiableList(splitKey_);
        }
        if (((mutable_bitField0_ & 0x00000080) == 0x00000080)) {
          rgId_ = java.util.Collections.unmodifiableList(rgId_);
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    // repeated bytes split_key = 7;
    public static final int SPLIT_KEY_FIELD_NUMBER = 7;
    private java.util.List<com.google.protobuf.ByteString> splitKey_;
    /**
     * <code>repeated bytes split_key = 7;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public com.google.protobuf.ByteString getSplitKey(int index) {
      return splitKey_.get(index);
    }

    // repeated int32 rg_id = 8 [packed = true];
    public static final int RG_ID_FIELD_NUMBER = 8;
    private java.util.List<java.lang.Integer> rgId_;
    /**
     * <code>repeated int32 rg_id = 8 [packed = true];</code>
     */
     ...
     * <code>repeated int32 rg_id = 8 [packed = true];</code>
     */
    public int getRgId(int index) {
      return rgId_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < splitKey_.size(); i++) {
        output.writeBytes(7, splitKey_.get(i));
      }
      if (getRgIdList().size() > 0) {
        output.writeRawVarint32(66);
        output.writeRawVarint32(rgIdMemoizedSerializedSize);
      }
      for (int i = 0; i < rgId_.size(); i++) {
      ...
      }
      {
        ...
        for (int i = 0; i < splitKey_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeBytesSizeNoTag(splitKey_.get(i));
        }
        size += dataSize;
        size += 1 * getSplitKeyList().size();
      }
      {
        int dataSize = 0;
        for (int i = 0; i < rgId_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(rgId_.get(i));
        }
        size += dataSize;
        if (!getRgIdList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        rgIdMemoizedSerializedSize = dataSize;
      }
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && getSplitKeyList()
          .equals(other.getSplitKeyList());
      result = result && getRgIdList()
          .equals(other.getRgIdList());
      result = result && (hasReplicaNamespace() == other.hasReplicaNamespace());
    ...
    public int hashCode() {
      ...
      if (getSplitKeyCount() > 0) {
        hash = (37 * hash) + SPLIT_KEY_FIELD_NUMBER;
        hash = (53 * hash) + getSplitKeyList().hashCode();
      }
      if (getRgIdCount() > 0) {
        hash = (37 * hash) + RG_ID_FIELD_NUMBER;
        hash = (53 * hash) + getRgIdList().hashCode();
      }
      if (hasReplicaNamespace()) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.RegionInfo other) {
        ...
        if (!other.splitKey_.isEmpty()) {
          if (splitKey_.isEmpty()) {
            splitKey_ = other.splitKey_;
            bitField0_ = (bitField0_ & ~0x00000040);
          } else {
            ensureSplitKeyIsMutable();
            splitKey_.addAll(other.splitKey_);
          }
          onChanged();
        }
        if (!other.rgId_.isEmpty()) {
          if (rgId_.isEmpty()) {
            rgId_ = other.rgId_;
            bitField0_ = (bitField0_ & ~0x00000080);
          } else {
            ensureRgIdIsMutable();
            rgId_.addAll(other.rgId_);
          }
          onChanged();
        }
  ...
  bitField0_ |= 0x00000008;
      ...
      // repeated bytes split_key = 7;
      private java.util.List<com.google.protobuf.ByteString> splitKey_ = java.util.Collections.emptyList();
      private void ensureSplitKeyIsMutable() {
        if (!((bitField0_ & 0x00000040) == 0x00000040)) {
          splitKey_ = new java.util.ArrayList<com.google.protobuf.ByteString>(splitKey_);
          bitField0_ |= 0x00000040;
         }
      }
      /**
      ...
      public java.util.List<com.google.protobuf.ByteString>
          getSplitKeyList() {
        return java.util.Collections.unmodifiableList(splitKey_);
      }
      /**
       * <code>repeated bytes split_key = 7;</code>
       *
       ...
       * </pre>
       */
      public Builder setSplitKey(
          int index, com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ensureSplitKeyIsMutable();
        splitKey_.set(index, value);
        onChanged();
        return this;
      }
      /**
       ...
       * </pre>
       */
      public Builder addSplitKey(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ensureSplitKeyIsMutable();
       ...
       * </pre>
       */
      public Builder addAllSplitKey(
          java.lang.Iterable<? extends com.google.protobuf.ByteString> values) {
        ensureSplitKeyIsMutable();
        super.addAll(values, splitKey_);
        onChanged();
        return this;
      }
      /**
      ...
      // repeated int32 rg_id = 8 [packed = true];
      private java.util.List<java.lang.Integer> rgId_ = java.util.Collections.emptyList();
      private void ensureRgIdIsMutable() {
        if (!((bitField0_ & 0x00000080) == 0x00000080)) {
          rgId_ = new java.util.ArrayList<java.lang.Integer>(rgId_);
          bitField0_ |= 0x00000080;
         }
      }
      /**
      ...
      public java.util.List<java.lang.Integer>
          getRgIdList() {
        return java.util.Collections.unmodifiableList(rgId_);
      }
      /**
       * <code>repeated int32 rg_id = 8 [packed = true];</code>
       */
       ...
       * <code>repeated int32 rg_id = 8 [packed = true];</code>
       */
      public Builder setRgId(
          int index, int value) {
        ensureRgIdIsMutable();
        rgId_.set(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated int32 rg_id = 8 [packed = true];</code>
       */
      public Builder addRgId(int value) {
        ensureRgIdIsMutable();
        rgId_.add(value);
        onChanged();
        return this;
       ...
       * <code>repeated int32 rg_id = 8 [packed = true];</code>
       */
      public Builder addAllRgId(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureRgIdIsMutable();
        super.addAll(values, rgId_);
        onChanged();
        return this;
      }
      /**
